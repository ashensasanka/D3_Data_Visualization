...
const E2016styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052689498445646.csv").then(function (data) {
            console.log(data);
...
export default E2016styleBarGraphInD3;
