...
const E2017styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052284684655656.csv").then(function (data) {
            console.log(data);
...
export default E2017styleBarGraphInD3;
