...
const E2015styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052484656559898.csv").then(function (data) {
            console.log(data);
...
export default E2015styleBarGraphInD3;
