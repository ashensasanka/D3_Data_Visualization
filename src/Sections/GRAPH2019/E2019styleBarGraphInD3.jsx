...
const E2019styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052654165448465.csv").then(function (data) {
            console.log(data);
...
export default E2019styleBarGraphInD3;
