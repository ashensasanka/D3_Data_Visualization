...
const E2014styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052265165156984.csv").then(function (data) {
            console.log(data);
...
export default E2014styleBarGraphInD3;
