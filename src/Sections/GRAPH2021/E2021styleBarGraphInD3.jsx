...
const E2021styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052586546856876.csv").then(function (data) {
            console.log(data);
...
export default E2021styleBarGraphInD3;
