...
const E2020styleBarGraphInD3 = () => {
    ...
    useEffect(() => {
        ...
        d3.csv("HEALTH_PROC_20052661652546152.csv").then(function (data) {
            console.log(data);
...
export default E2020styleBarGraphInD3;
